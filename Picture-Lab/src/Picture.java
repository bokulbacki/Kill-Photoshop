  ...
  /** Method to set the blue to 0 */
	...
	public void mirrorGull()
	{
		int mirrorPoint = 365;
		 ...
		 if((pixels[row][col].getRed() > 8) && (pixels[row][col].getRed() < 222) 
				 && (pixels[row][col].getBlue() > 8) && (pixels[row][col].getBlue() < 121)
				 && (pixels[row][col].getGreen() > 15) && (pixels[row][col].getGreen() <190 ))
			 {
				 rightPixel.setColor(leftPixel.getColor());
			 }
		 }
